...
export default function ComplaintCard({ complaint, onClick, className }) {
    ...
    const renderSLA = () => {
        ...
        return (
            <span className={clsx("flex items-center gap-1", isOverdue ? "text-red-600 font-semibold" : "text-amber-600 font-medium")}>
    ...
    const isOverdue = status !== 'resolved' && status !== 'closed' && slaDeadline && isPast(new Date(slaDeadline));
            ...
            <div className="p-5 flex gap-4">
                ...
                <div className="flex-1 min-w-0 flex flex-col">
                    <div className="flex justify-between items-start gap-2 mb-1.5">
                        ...
                        <span className={clsx("px-2.5 py-1 rounded-full text-[10px] font-semibold whitespace-nowrap flex items-center gap-1.5", displayBadge.bg, displayBadge.text)}>

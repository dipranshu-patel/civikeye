...
import { 
    LayoutDashboard, Megaphone, Search, List, ShieldCheck, Users, Building2, Settings as SettingsIcon 
} from "lucide-react";
...
const citizenNavGroups = [
    {
        ...
        items: [
            ...
            { name: "Report Complaint", path: "/citizen/report-complaint", icon: Megaphone },
            { name: "Explore Complaints", path: "/citizen/explore-complaints", icon: Search },
            { name: "My Complaints", path: "/citizen/my-complaints", icon: List },
            { name: "Verification Requests", path: "/citizen/verification-requests", icon: ShieldCheck },
            { name: "Volunteer", path: "/citizen/volunteer", icon: Users },
            { name: "Departments", path: "/citizen/departments", icon: Building2 },
        ],
    },
    {
        title: "ACCOUNT",

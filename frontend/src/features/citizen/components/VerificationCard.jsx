...
export default function VerificationCard({
    ...
    const { publicCode, title, category, department, addressText, coverPhoto } =
        details;
                ...
                <div className="flex-1 min-w-0 flex flex-col">
                    <div className="flex justify-between items-start gap-2 mb-1.5">
                        ...
                        {isHistory ? (
                            ...
                            <span
                                className={clsx(
                                    "px-2.5 py-1 rounded-full text-[10px] font-semibold whitespace-nowrap flex items-center gap-1.5 bg-indigo-50 text-indigo-700",
                                )}
                            >
            ...
            <div className="px-5 py-3.5 bg-gray-50 border-t border-gray-100 flex flex-col gap-3">
                <div className="flex items-center justify-between text-xs text-gray-500 font-medium">
                    <div className="flex items-center gap-1.5">
                        ...
                        <span>
                            {tally.confirms} / {tally.minVotes} needed
                        </span>
                    </div>

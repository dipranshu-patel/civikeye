...
import { 
    User, Mail, MapPin, Eye, Settings as SettingsIcon, Shield, Key, 
    LogOut, Trash2, ChevronRight, X, Loader2 
} from "lucide-react";
    ...
    return (
        <div className="max-w-5xl mx-auto pb-20">
            <div className="mb-10">
                ...
                <p className="text-gray-500 mt-2">Manage your civic profile, preferences, and how your contributions appear on the public ledger.</p>
            </div>
            ...
            <section className="mb-12">
                ...
                <p className="text-sm text-gray-500 mb-6">Your public identity on CivikEye.</p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 border-t border-gray-100">
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-gray-900 font-medium">
                                {profile.location ? `${profile.location.latitude.toFixed(4)}, ${profile.location.longitude.toFixed(4)}` : "Location not set"}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="mb-12">
                ...
                <h2 className="text-xl font-bold text-gray-900 mb-1">Public visibility</h2>
                <p className="text-sm text-gray-500 mb-6">How your civic activity appears on the public ledger.</p>

                <div className="bg-white border border-gray-200 rounded-2xl shadow-sm divide-y divide-gray-100">
                    <div className="p-6 flex items-center justify-between gap-4">
                        <div>
                            <h3 className="font-semibold text-gray-900">Show my name on complaints</h3>
                            <p className="text-sm text-gray-500 mt-1">When off, complaints appear as Anonymous on the public feed.</p>
                        </div>
                        <Toggle 
                            enabled={preferences?.showNameOnComplaints} 
                            onChange={(val) => handlePrefChange('showNameOnComplaints', val)} 
                        />
                    </div>
                    <div className="p-6 flex items-center justify-between gap-4">
                        <div>
                            <h3 className="font-semibold text-gray-900">Appear on community leaderboard</h3>
                            <p className="text-sm text-gray-500 mt-1">Verified contributions remain public regardless of this setting.</p>
                        </div>
                        <Toggle 
                            enabled={preferences?.appearOnLeaderboard} 
                            onChange={(val) => handlePrefChange('appearOnLeaderboard', val)} 
                        />
                    </div>
                </div>
                    ...
                    <div className="p-6">
                        <div className="flex items-start gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-0.5">Determines nearby civic alerts and ward feed.</p>
                            </div>
                        </div>
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 border-t border-gray-100 pt-6">
                            <div>
                                <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Current Location</p>
                                <p className="font-medium text-gray-900">
                                    {profile.location ? `${profile.location.latitude.toFixed(4)}, ${profile.location.longitude.toFixed(4)}` : "Location not set"}
                                </p>
                                <p className="text-xs text-gray-500 mt-1">Auto-detected from device</p>
                            </div>
                            <div className="flex items-center gap-6">
                                <div className="hidden sm:block">
                                    <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1">Permission</p>
                                    <p className="flex items-center gap-1.5 text-sm font-medium text-emerald-600">
                                        <span className="w-2 h-2 rounded-full bg-emerald-500"></span> Granted
                                    </p>
                                </div>
                                <div className="flex flex-col items-start sm:items-end gap-2">
                                    ...
                                    >
                                        {updatingLocation && <Loader2 className="w-4 h-4 animate-spin" />}
                                        Update location
                                    </button>
                                    {locationError && (
            ...
            <section className="mb-12">
                ...
                <h2 className="text-xl font-bold text-gray-900 mb-1">Privacy & transparency</h2>
                <p className="text-sm text-gray-500 mb-6">What stays private, and what stays publicly verifiable.</p>
                ...
                <div className="bg-white border border-gray-200 rounded-2xl shadow-sm divide-y divide-gray-100 mb-4">
                    <div className="p-6 flex items-center justify-between gap-4 bg-gray-50/50">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900">Public ledger visibility</h3>
                                <p className="text-sm text-gray-500 mt-0.5">Your verified complaints appear on the public CivikEye ledger.</p>
                            </div>
                        </div>
                    ...
                    <div className="p-6 flex items-center justify-between gap-4 bg-gray-50/50">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-0.5">Your volunteer efforts help resolve and verify civic issues in your community.</p>
                            </div>
                        </div>
                        <span className="text-xs font-bold text-gray-600 uppercase tracking-widest">
                            {profile.communityVerification === 'verified' ? 'Participating' : 'Not Applicable'}
                        </span>
                    </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-2xl shadow-sm">
                    <div className="p-6 flex items-center justify-between gap-4">
                        <div>
                            <h3 className="font-semibold text-gray-900">Show contribution history publicly</h3>
                            <p className="text-sm text-gray-500 mt-1">Let others see your reports, verifications, and resolutions on your public profile.</p>
                        </div>
                        <Toggle 
                            enabled={preferences?.showContributionHistory} 
                            onChange={(val) => handlePrefChange('showContributionHistory', val)} 
                        />
                    </div>
                </div>
                <p className="text-xs text-gray-500 mt-4 px-2">Your verified civic contributions remain publicly visible on CivikEye to preserve accountability.</p>
            </section>
            ...
            <section>
                ...
                <h2 className="text-xl font-bold text-gray-900 mb-1">Account actions</h2>
                <p className="text-sm text-gray-500 mb-6">Manage credentials, export your civic activity, or close your account.</p>
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-0.5">Last updated {profile.passwordChangedAt ? new Date(profile.passwordChangedAt).toLocaleDateString() : 'never'}</p>
                            </div>
                        </div>
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-0.5">End this session on this device</p>
                            </div>
                        </div>
                        <ChevronRight className="w-5 h-5 text-gray-300 group-hover:text-gray-500" />
                    </button>
                    ...
                    >
                        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-red-600/80 mt-0.5">Removes your private profile. Your verified public ledger contributions remain anonymized.</p>
                            </div>
                        </div>
            ...
            {isEditProfileOpen && (
                <EditProfileModal 
                    ...
                    onSuccess={(updated) => setProfile({...profile, ...updated})} 
                />
            )}
...
function EditProfileModal({ profile, onClose, onSuccess }) {
    ...
    // Email change state
    const [emailStep, setEmailStep] = useState("idle"); // idle | enterEmail | otpSent | done
    ...
    const handleSaveName = async (e) => {
        ...
        try {
            ...
            setError(err.response?.data?.errors?.[0]?.message || err.response?.data?.message || "Failed to update profile");
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleRequestEmailChange = async (e) => {
        ...
        try {
            ...
            setError(err.response?.data?.errors?.[0]?.message || err.response?.data?.message || "Failed to send OTP");
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleConfirmEmailChange = async (e) => {
        ...
        try {
            ...
            setError(err.response?.data?.errors?.[0]?.message || err.response?.data?.message || "Invalid OTP. Please try again.");
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl overflow-hidden relative">
                <div className="p-6 border-b border-gray-100 flex items-center justify-between">
                    <h2 className="text-xl font-bold text-gray-900">
                        {emailStep === "otpSent" ? "Verify new email" : "Edit Profile"}
                    </h2>
                    <button onClick={onClose} className="p-2 hover:bg-gray-100 rounded-full text-gray-500 transition-colors cursor-pointer">
                        <X className="w-5 h-5" />
                    </button>
                </div>
                ...
                {emailStep === "done" ? (
                    <div className="p-10 text-center flex flex-col items-center">
                        ...
                        <h3 className="text-xl font-bold text-gray-900">Email Updated</h3>
                        <p className="text-gray-500 mt-2">Your email has been changed successfully.</p>
                    </div>
                ) : emailStep === "otpSent" ? (
                    <form onSubmit={handleConfirmEmailChange} className="p-6">
                        <p className="text-sm text-gray-600 mb-6 leading-relaxed">
                            A 6-digit code was sent to <span className="font-semibold text-gray-900">{newEmail}</span>. Enter it below to confirm your new email address.
                        </p>
                        {error && (
                            <div className="mb-5 p-4 bg-red-50 text-red-600 text-sm rounded-xl border border-red-100 font-medium">{error}</div>
                        )}
                        <div className="mb-8">
                            ...
                            <input
                                ...
                                autoFocus
                            />
                            <p className="text-xs text-gray-500 mt-2">Code expires in 10 minutes. <button type="button" className="text-gray-700 underline" onClick={() => { setEmailStep("enterEmail"); setError(null); setOtp(""); }}>Use a different email</button></p>
                        </div>
                        <div className="flex items-center gap-3 justify-end">
                            <button type="button" onClick={onClose} className="px-5 py-2.5 bg-white border border-gray-200 text-gray-700 rounded-xl text-sm font-semibold hover:bg-gray-50 transition-colors cursor-pointer">Cancel</button>
                            <button type="submit" disabled={loading || otp.trim().length < 6} className="px-5 py-2.5 bg-gray-900 text-white rounded-xl text-sm font-semibold hover:bg-gray-800 transition-colors disabled:opacity-50 flex items-center gap-2 cursor-pointer">
                    ...
                    <form onSubmit={handleRequestEmailChange} className="p-6">
                        <p className="text-sm text-gray-600 mb-6 leading-relaxed">
                            Enter your new email address. We'll send a verification code to confirm you own it before updating.
                        </p>
                        {error && (
                            <div className="mb-5 p-4 bg-red-50 text-red-600 text-sm rounded-xl border border-red-100 font-medium">{error}</div>
                        )}
                        ...
                        <div className="flex items-center gap-3 justify-end">
                            <button type="button" onClick={() => { setEmailStep("idle"); setError(null); }} className="px-5 py-2.5 bg-white border border-gray-200 text-gray-700 rounded-xl text-sm font-semibold hover:bg-gray-50 transition-colors cursor-pointer">Back</button>
                            <button type="submit" disabled={loading} className="px-5 py-2.5 bg-gray-900 text-white rounded-xl text-sm font-semibold hover:bg-gray-800 transition-colors disabled:opacity-50 flex items-center gap-2 cursor-pointer">
                                {loading && <Loader2 className="w-4 h-4 animate-spin" />}
                    ...
                    /* Default: edit name + trigger email change */
                    <form onSubmit={handleSaveName} className="p-6">
                        {error && (
                            <div className="mb-6 p-4 bg-red-50 text-red-600 text-sm rounded-xl border border-red-100 font-medium">{error}</div>
                        )}
                        <div className="mb-5">
                        ...
                        <div className="mb-8">
                            ...
                            <div className="flex items-center gap-3 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl min-w-0">
                                <span className="text-sm font-medium text-gray-400 flex-1 truncate min-w-0" title={profile.email}>{profile.email}</span>
                                <button
                                    type="button"
                                    onClick={() => { setEmailStep("enterEmail"); setError(null); }}
                                    className="text-xs font-semibold text-gray-600 hover:text-gray-900 underline shrink-0 cursor-pointer"
                                >
                                    Change
                                </button>
                            </div>
                            <p className="text-xs text-gray-500 mt-2">Changing email requires verification via a one-time code.</p>
                        </div>
                        <div className="flex items-center gap-3 justify-end">
                            <button type="button" onClick={onClose} className="px-5 py-2.5 bg-white border border-gray-200 text-gray-700 rounded-xl text-sm font-semibold hover:bg-gray-50 transition-colors cursor-pointer">Cancel</button>
                            <button type="submit" disabled={loading} className="px-5 py-2.5 bg-gray-900 text-white rounded-xl text-sm font-semibold hover:bg-gray-800 transition-colors disabled:opacity-50 flex items-center gap-2 cursor-pointer">
...
function ChangePasswordModal({ onClose }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(err.response?.data?.errors?.[0]?.message || err.response?.data?.message || "Failed to change password");
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl overflow-hidden relative">
                ...
                {success ? (
                    <div className="p-10 text-center flex flex-col items-center">
                        ...
                        <p className="text-gray-500 mt-2">Your password has been changed successfully.</p>
                    </div>
                ) : (
...
function DeleteAccountModal({ onClose, onSuccess }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(err.response?.data?.errors?.[0]?.message || err.response?.data?.message || "Failed to delete account");
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="fixed inset-0 z-50 bg-gray-900/40 backdrop-blur-sm flex items-center justify-center p-4">
            <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl overflow-hidden relative border border-red-100">
                <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-red-50/50">
                    ...
                    <button onClick={onClose} className="p-2 hover:bg-red-100 rounded-full text-red-500 transition-colors cursor-pointer">
                        <X className="w-5 h-5" />
                    </button>
                </div>
                <form onSubmit={handleSubmit} className="p-6">
                    <div className="mb-6">
                        <p className="text-gray-700 text-sm leading-relaxed mb-4">
                            Deleting your account is permanent. Your personal data will be removed, but your verified civic contributions will remain on the public ledger in an anonymized state.
                        </p>

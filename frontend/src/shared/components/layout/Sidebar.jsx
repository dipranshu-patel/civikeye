        ...
        <>
            ...
            <div className={clsx(
                ...
                {isSidebarOpen && (
                    <div className="flex items-center gap-2 overflow-hidden whitespace-nowrap">
                        <img src={LogoSVG} alt="CivikEye Logo" className="h-8 w-8 shrink-0" />
            ...
            <nav className={clsx(
                ...
                {navGroups.map((group, idx) => (
                    <div key={idx} className={clsx("mb-6", isSidebarOpen ? "px-3" : "px-0")}>
                            ...
                            {group.items.map((item) => {
                                ...
                                return (
                                    <li key={item.name}>
                                        ...
                                        >
                                            <Icon className={clsx("w-5 h-5 shrink-0 transition-all", isActive ? "text-blue-700" : "text-gray-500")} />

    ...
    return (
        <div className="w-full">
            <div className="relative flex items-center w-full h-10">
                {Icon && (
                    <div className="pointer-events-none absolute flex items-center justify-center text-gray-500 z-10" style={{ left: "0.75rem" }}>
                ...
                />
                {RightIcon && (
                    <div className="pointer-events-none absolute flex items-center justify-center text-green-500 z-10" style={{ right: "0.75rem" }}>
